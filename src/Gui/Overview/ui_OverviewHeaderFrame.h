...
public:
    ...
    WalletGui::WalletSmallGrayTextLabel *m_overviewNodeTextLabel;
    WalletGui::WalletSmallBlackTextLabel *m_overviewMasternode;
    QSpacerItem *horizontalSpacer_3;
    QSpacerItem *verticalSpacer_9;
    WalletGui::WalletSmallGrayTextLabel *m_overviewNodeStateTextLabel;
    WalletGui::WalletSmallBlackTextLabel *m_overviewConnectionState;
    WalletGui::WalletSmallGrayTextLabel *m_overviewNodeFeeTextLabel;
    WalletGui::WalletSmallBlackTextLabel *m_overviewNodeFeeLabel;
    WalletGui::WalletSmallGrayTextLabel *m_overviewNodeVersionTextLabel;
    ...
    void setupUi(QFrame *OverviewHeaderFrame)
    {
        ...
        gridLayout->setContentsMargins(30, 15, -1, 15);
        ...
        gridLayout_2 = new QGridLayout(m_overviewNodeFrame);
        gridLayout_2->setObjectName(QStringLiteral("gridLayout_2"));
        gridLayout_2->setContentsMargins(30, 15, 30, 15);
        verticalSpacer_5 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_2->addItem(verticalSpacer_5, 0, 0, 1, 5);

        label_9 = new WalletGui::WalletHeaderLabel(m_overviewNodeFrame);
        label_9->setObjectName(QStringLiteral("label_9"));
        label_9->setIndent(0);

        gridLayout_2->addWidget(label_9, 1, 2, 1, 2);

        m_overviewNodeTextLabel = new WalletGui::WalletSmallGrayTextLabel(m_overviewNodeFrame);
        ...
        gridLayout_2->addWidget(m_overviewNodeTextLabel, 2, 2, 1, 1);

        m_overviewMasternode = new WalletGui::WalletSmallBlackTextLabel(m_overviewNodeFrame);
        ...
        gridLayout_2->addWidget(m_overviewMasternode, 2, 3, 2, 1);

        horizontalSpacer_3 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_2->addItem(horizontalSpacer_3, 2, 4, 3, 1);

        verticalSpacer_9 = new QSpacerItem(20, 0, QSizePolicy::Minimum, QSizePolicy::Fixed);

        gridLayout_2->addItem(verticalSpacer_9, 3, 2, 1, 1);

        m_overviewNodeStateTextLabel = new WalletGui::WalletSmallGrayTextLabel(m_overviewNodeFrame);
        ...
        gridLayout_2->addWidget(m_overviewNodeStateTextLabel, 4, 2, 1, 1);

        m_overviewConnectionState = new WalletGui::WalletSmallBlackTextLabel(m_overviewNodeFrame);
        m_overviewConnectionState->setObjectName(QStringLiteral("m_overviewConnectionState"));
        m_overviewConnectionState->setIndent(0);

        gridLayout_2->addWidget(m_overviewConnectionState, 4, 3, 1, 1);

        m_overviewNodeFeeTextLabel = new WalletGui::WalletSmallGrayTextLabel(m_overviewNodeFrame);
        m_overviewNodeFeeTextLabel->setObjectName(QStringLiteral("m_overviewNodeFeeTextLabel"));
        m_overviewNodeFeeTextLabel->setIndent(0);

        gridLayout_2->addWidget(m_overviewNodeFeeTextLabel, 5, 2, 1, 1);
        ...
        m_overviewNodeVersionTextLabel = new WalletGui::WalletSmallGrayTextLabel(m_overviewNodeFrame);
        ...
        gridLayout_2->addWidget(m_overviewNodeVersionTextLabel, 6, 2, 1, 1);
        ...
        gridLayout_2->addWidget(m_overviewNodeVersionLabel, 6, 3, 1, 1);

        verticalSpacer_6 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_2->addItem(verticalSpacer_6, 7, 0, 1, 5);
        ...
        gridLayout_2->addWidget(m_overviewNodeIconLabel, 1, 0, 6, 1);

        horizontalSpacer_6 = new QSpacerItem(20, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);

        gridLayout_2->addItem(horizontalSpacer_6, 1, 1, 6, 1);
